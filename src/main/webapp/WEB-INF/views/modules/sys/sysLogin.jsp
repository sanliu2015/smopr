...
<body>
	...
	<form id="loginForm" class="form-signin" action="${ctx}/login" method="post">
		...
		<a class="btn btn-warning" href="${pageContext.request.contextPath}${fns:getAdminPath()}/register/init">注 册</a>
		<label for="rememberMe" title="下次不需要再登录"><input type="checkbox" id="rememberMe" name="rememberMe" ${rememberMe ? 'checked' : ''}/> 记住密码/<a href="" >忘记密码</label>
	</form>
	<div class="footer">
